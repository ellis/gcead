...
#include <Idac/Idac.h>
#include <Task/TaskPanel.h>
#include <Task/TaskPublishWidget.h>
#include <Task/TaskReviewWidget.h>
#include <View/ViewTabs.h>

#ifdef Q_WS_WIN
#include <Idac/Idac_windows.h>
#else
#include <Idac/Idac_linux.h>
#endif
	...
	: QMainWindow(parent, flags)
{
	...
	Idac* idac = NULL;
	#ifdef Q_WS_WIN
	idac = new Idac_windows(statusBar(), this);
	#else
	idac = new Idac_linux(this);
	#endif
...
void MainWindow::setupActions()
{
	...
	ui.mnuRecord->addAction(actions->recordOptions);
...
void MainWindow::writeSettings()
{
	...
	Globals->writeSettings(settings);
}
